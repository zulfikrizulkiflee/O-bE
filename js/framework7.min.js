...
! function () {
    ...
    window.Framework7 = function (a) {
        ...
        function n() {
            ...
            if (i || (i = 50), "string" == typeof i && i.indexOf("%") >= 0 && (i = parseInt(i, 10) / 100 * r), i > r && (i = r), l) t < i && a.trigger("infinite");
            else if (t + r >= n - i) {
            ...
            if (s.handleTouchStart = function (e) {
                    ...
                    if (I) {
                        ...
                        if (!E) {
                            ...
                            p.length > 0 && (!i.rtl && p.find(".swipeout-actions-left").length > 0 && (n = !0), i.rtl && p.find(".swipeout-actions-right").length > 0 && (n = !0)), D = r.is(".page") ? r : r.parents(".page"), D.hasClass("no-swipeback") && (n = !0), z = l.find(".page-on-left:not(.cached)");
                            var d = O.x - l.offset().left > s.params.swipeBackPageActiveArea;
                            if (d = i.rtl ? O.x < l.offset().left - l[0].scrollLeft + b - s.params.swipeBackPageActiveArea : O.x - l.offset().left > s.params.swipeBackPageActiveArea, d && (n = !0), 0 !== z.length && 0 !== D.length || (n = !0), n) return void(I = !1);
                        ...
                        var f = w * c,
                            h = (w / 5 - b / 5) * c;
                        if (1 === i.device.pixelRatio && (f = Math.round(f), h = Math.round(h)), D.transform("translate3d(" + f + "px,0,0)"), s.params.swipeBackPageAnimateShadow && !i.device.android && (S[0].style.opacity = 1 - 1 * u), z.transform("translate3d(" + h + "px,0,0)"), s.params.swipeBackPageAnimateOpacity && (z[0].style.opacity = .9 + .1 * u), P) {
                            var g;
                    ...
                    if (I = !1, E = !1, 0 === w) return o([D[0], z[0]]).transform("").css({
                        opacity: "",
                        boxShadow: ""
                    ...
                    var a = (new Date).getTime() - C,
                        t = !1;
                    (a < 300 && w > 10 || a >= 300 && w > b / 2) && (D.removeClass("page-on-center").addClass("page-on-right"), z.removeClass("page-on-left").addClass("page-on-center"), P && (B.removeClass("navbar-on-center").addClass("navbar-on-right"), N.removeClass("navbar-on-left").addClass("navbar-on-center")), t = !0), o([D[0], z[0]]).transform("").css({
                        opacity: "",
                        boxShadow: ""
                    ...
                    D.transitionEnd(function () {
                        o([D[0], z[0]]).removeClass("page-transitioning"), P && (y.removeClass("page-transitioning").css({
                            opacity: ""
                        }), x.removeClass("page-transitioning").css({
                            opacity: ""
                        }), T && T.length > 0 && T.removeClass("page-transitioning"), k && k.length > 0 && k.removeClass("page-transitioning")), L = !0, s.allowPageChange = !0, t ? (i.params.pushState && s.main && history.back(), i.pageBackCallback("after", s, {
                            pageContainer: D[0],
                            url: r,
                            position: "center",
                            newPage: z,
                            ...
                            oldPage: D,
                            swipeBack: !0
                        }), i.router.afterBack(s, D, z), s.params.onSwipeBackAfterChange && s.params.onSwipeBackAfterChange(n), l.trigger("swipeBackAfterChange", n)) : (s.params.onSwipeBackAfterReset && s.params.onSwipeBackAfterReset(n), l.trigger("swipeBackAfterReset", n)), S && S.length > 0 && S.remove()
                    })
                    ...
                    l[a](i.touchEvents.start, s.handleTouchStart, t), l[a](i.touchEvents.move, s.handleTouchMove), l[a](i.touchEvents.end, s.handleTouchEnd, t)
        ...
        i.addView = function (e, a) {
            ...
            i.pluginHook("navbarBeforeRemove", s, r), o(n).trigger("navbarBeforeRemove", l), s = null, r = null
        ...
        var d = function (e, a) {
            ...
            s.setCancelButtonMargin = function () {
                ...
                s.input.val("").trigger("change"), s.container.removeClass("searchbar-active searchbar-not-empty"), s.cancelButton.length > 0 && !s.material && s.cancelButton.css(l, -s.cancelButton[0].offsetWidth + "px"), (s.searchList.length || s.params.customSearch) && s.overlay.removeClass("searchbar-overlay-active"), s.active = !1, i.device.ios ? setTimeout(function () {
                    e()
                }, 400) : e(), s.triggerEvent("disableSearch", "onDisable")
            }, s.clear = function (e) {
                return !s.query && e && o(e.target).hasClass("searchbar-clear") ? void s.disable() : (s.input.val("").trigger("change").focus(), void s.triggerEvent("clearSearch", "onClear"))
            ...
            return s.search = function (e, a) {
                if (e.trim() !== c) {
                    ...
                    if (s.isVirtualList) {
                        ...
                        if (t = s.params.removeDiacritics ? o.removeDiacritics(e) : e, d.params.searchAll) n = d.params.searchAll(t, d.items) || [];
                        else if (d.params.searchByItem)
                            for (var r = 0; r < d.items.length; r++) d.params.searchByItem(t, r, d.params.items[r]) && n.push(r)
                    } else {
                        var i;
                        i = s.params.removeDiacritics ? o.removeDiacritics(e.trim().toLowerCase()).split(" ") : e.trim().toLowerCase().split(" "), s.searchList.find("li").removeClass("hidden-by-searchbar").each(function (e, a) {
                            ...
                            var e = o(this),
                                a = s.params.ignore && e.is(s.params.ignore),
        ...
        i.triggerPageCallbacks = function (e, a, t) {
            ...
            template7Render: function (e, a) {
                var t, n, r = a.url,
                    ...
                    u = a.template;
                a.pageName;
                if ("string" == typeof s ? r ? i.template7Cache[r] && !a.ignoreCache ? n = l.cache[r] : (n = l.compile(s), l.cache[r] = n) : n = l.compile(s) : u && (n = u), d) t = d, d && r && (e.contextCache[r] = d);
                else {
                    if (c)
                        if (c.indexOf(".") >= 0) {
            ...
            var n, r, s, l, p, d, c, u, m, f = a.url,
                ...
                T = a.pushState,
                k = a.pageElement;
            if ("undefined" == typeof y && (y = e.params.animatePages), i.pluginHook("routerLoad", e, a), (i.params.template7Pages && "string" == typeof h || v) && (g = i.router.template7Render(e, a), g.content && !h && (h = g.content)), i.router.temporaryDom.innerHTML = "", !b && !k)
                if ("string" == typeof h || f && "string" == typeof h) i.router.temporaryDom.innerHTML = g.content;
                else if ("length" in h && h.length > 1)
                for (var P = 0; P < h.length; P++) o(i.router.temporaryDom).append(h[P]);
            ...
            if (e.params.uniqueHistory) {
                ...
                if (e.params.uniqueHistoryIgnoreGetParameters)
                    for (D = [], z = f.split("?")[0], l = 0; l < e.history.length; l++) D.push(e.history[l].split("?")[0]);
                D.indexOf(z) !== D.lastIndexOf(z) && (e.history = e.history.slice(0, D.indexOf(z)), e.history.push(f), O = !0)
            }
            ...
            function s() {
                ...
                if (e.params.dynamicNavbar && "undefined" == typeof f && (f = !(!c || 0 === c.length)), p.addClass("page-on-left").removeClass("cached"), f && (u = P.children(".navbar"), m = u.find(".navbar-inner:not(.cached)"), c.addClass("navbar-on-left").removeClass("cached")), x) {
                    var t, r;
                    if (t = o(M[M.length - 2]), f && (r = o(t[0] && t[0].f7RelatedNavbar || m[m.length - 2])), e.params.domCache && e.initialPages.indexOf(t[0]) >= 0) t.length && t[0] !== p[0] && t.addClass("cached"), f && r.length && r[0] !== c[0] && r.addClass("cached");
                    else {
                        var s = f && r.length;
            ...
            if (p) {
                ...
                else if (0 !== n.indexOf("#")) return void i.get(a.url, e, a.ignoreCache, function (a, n) {
                    return n ? void(e.allowPageChange = !0) : void t(a)
                })
            }
            e.allowPageChange = !0
        ...
        i.modalStack = [], i.modalStackClearQueue = function () {
            ...
            if (s) {
                ...
                f.innerHTML = p, t = o(f).children(), i.root.append(t[0]), n = ".actions-modal-group", r = ".actions-modal-button"
            }
            var b = t.find(n);
            ...
            function n() {
                ...
                var f = o(window).height(),
                    ...
                    w = s ? "bottom" : "top";
                if (s) {
                    if (l < f - u.top - c ? (w = "bottom", g = u.top) : l < u.top ? (g = u.top - l + c, w = "top") : (w = "bottom", g = u.top), g <= 0 ? g = 8 : g + l >= f && (g = f - l - 8), v = u.left, v + i >= h - 8 && (v = u.left + d - i - 8), v < 8 && (v = 8), "top" === w && e.addClass("popover-on-top"), "bottom" === w && e.addClass("popover-on-bottom"), a.hasClass("floating-button-to-popover") && !e.hasClass("modal-in")) {
                ...
                } else l + p < u.top ? g = u.top - l - p : l + p < f - u.top - c ? (w = "bottom", g = u.top + c + p) : (w = "middle", g = c / 2 + u.top - l / 2, b = g, g <= 0 ? g = 5 : g + l >= f && (g = f - l - 5), b -= g), "top" === w || "bottom" === w ? (v = d / 2 + u.left - i / 2, b = v, v < 5 && (v = 5), v + i > h && (v = h - i - 5), "top" === w && t.addClass("on-bottom"), "bottom" === w && t.addClass("on-top"), b -= v, n = i / 2 - p + b, n = Math.max(Math.min(n, i - 2 * p - 13), 13), t.css({
                    left: n + "px"
                })) : "middle" === w && (v = u.left - i - p, t.addClass("on-right"), (v < 5 || v + i > h) && (v < 5 && (v = u.left + d + p), v + i > h && (v = h - i - 5), t.removeClass("on-right").addClass("on-left")), r = l / 2 - p + b, r = Math.max(Math.min(r, l - 2 * p - 13), 13), t.css({
                    top: r + "px"
                }));
                e.css({
                    top: g + "px",
            ...
            if ("undefined" == typeof t && (t = !0),
                ...
                e = r.childNodes[0], t && e.classList.add("remove-on-close"), i.root.append(e)
            }
            if (e = o(e), a = o(a), 0 === e.length || 0 === a.length) return !1;
            0 === e.parents("body").length && (t && e.addClass("remove-on-close"), i.root.append(e[0])), 0 !== e.find(".popover-angle").length || i.params.material || e.append('<div class="popover-angle"></div>'), e.show();
            ...
            if ("undefined" == typeof a && (a = !0), "string" == typeof e && e.indexOf("<") >= 0) {
                ...
                e = t.childNodes[0], a && e.classList.add("remove-on-close"), i.root.append(e)
            }
            return e = o(e), 0 !== e.length && (0 === e.parents("body").length && (a && e.addClass("remove-on-close"), i.root.append(e[0])), e.show(), i.openModal(e), e[0])
        }, i.pickerModal = function (e, a) {
            if ("undefined" == typeof a && (a = !0), "string" == typeof e && e.indexOf("<") >= 0) {
                if (e = o(e), !(e.length > 0)) return !1;
                a && e.addClass("remove-on-close"), i.root.append(e[0])
            }
            return e = o(e), 0 !== e.length && (0 === e.parents("body").length && (a && e.addClass("remove-on-close"), i.root.append(e[0])), o(".picker-modal.modal-in:not(.modal-out)").length > 0 && !e.hasClass("modal-in") && i.closeModal(".picker-modal.modal-in:not(.modal-out)"), e.show(), i.openModal(e), e[0])
        }, i.loginScreen = function (e) {
            return e || (e = ".login-screen"), e = o(e), 0 !== e.length && (o(".login-screen.modal-in:not(.modal-out)").length > 0 && !e.hasClass("modal-in") && i.closeModal(".login-screen.modal-in:not(.modal-out)"), e.show(), i.openModal(e), e[0])
            ...
            if (!0 !== e.data("f7-modal-shown")) {
                ...
                var s;
                n || r || (0 !== o(".modal-overlay").length || t || i.root.append('<div class="modal-overlay"></div>'), 0 === o(".popup-overlay").length && t && i.root.append('<div class="popup-overlay"></div>'), s = o(t ? ".popup-overlay" : ".modal-overlay")), i.params.material && r && e.hasClass("picker-calendar") && (0 !== o(".picker-modal-overlay").length || t || i.root.append('<div class="picker-modal-overlay"></div>'), s = o(".picker-modal-overlay"));
                e[0].clientLeft;
            ...
            function a(e) {
                if (s && !e.f7PreventPanelSwipe) {
                    ...
                    if (!v && (v = a > w.x ? "to-right" : "to-left", "both" === r && (r = o(".panel.active").length > 0 ? o(".panel.active").hasClass("panel-left") ? "left" : "right" : "to-right" === v ? "left" : "right", n = o(".panel.panel-" + r)), "left" === r && "to-left" === v && !n.hasClass("active") || "right" === r && "to-right" === v && !n.hasClass("active"))) return void(s = !1);
            ...
            function t(e) {
                ...
                var a, t = (new Date).getTime() - d,
                    p = 0 === u || Math.abs(u) === h;
                if (a = f ? u === -h ? "reset" : t < 300 && Math.abs(u) >= 0 || t >= 300 && Math.abs(u) <= h / 2 ? "left" === r && u === h ? "reset" : "swap" : "reset" : 0 === u ? "reset" : t < 300 && Math.abs(u) > 0 || t >= 300 && Math.abs(u) >= h / 2 ? "swap" : "reset", "swap" === a && (i.allowPanelOpen = !0, f ? (i.closePanel(), p && (n.css({
                        display: ""
            ...
            var s, l, p, d, c, u, m, f, h, g, v, b = o(".panel-overlay"),
                ...
                y = !("touchstart" !== i.touchEvents.start || !i.support.passiveListener) && {
                    passive: !0,
                    capture: !1
                };
            o(document).on(i.touchEvents.start, e, y), o(document).on(i.touchEvents.move, a), o(document).on(i.touchEvents.end, t, y)
        ...
        var h = function (e, a) {
            ...
            if (r.params = a, r.container = o(e), 0 !== r.container.length) return r.params.autoLayout && r.container.addClass("messages-auto-layout"), r.params.newMessagesFirst && r.container.addClass("messages-new-first"), r.pageContainer = r.container.parents(".page").eq(0), r.pageContent = r.pageContainer.find(".page-content"), r.template = Template7.compile(r.params.messageTemplate), r.layout = function () {
                ...
                if (r.container[a](i), r.params.autoLayout && r.layout(), "prepend" === a && (r.pageContent[0].scrollTop = p + (r.pageContent[0].scrollHeight - o)), r.params.scrollMessages && "append" === a && !r.params.newMessagesFirst || "prepend" === a && r.params.newMessagesFirst)
                ...
                var u = [];
                if ("append" === a)
                    for (n = c.length - e.length; n < c.length; n++) u.push(c[n]);
                else
                    for (n = 0; n < e.length; n++) u.push(c[n]);
                return u
        ...
        i.messages = function (e, a) {
            ...
            function t(e) {
                if (r) {
                    ...
                    x = v < 0 ? "to-left" : v > 0 ? "to-right" : x ? x : "to-left";
                    var n, p, O;
                    ...
                    var D;
                    if (m.length > 0)
                        for (O = v / g, v < -g && (v = -g - Math.pow(-v - g, .8), k.length > 0 && (S = !0)), n = 0; n < y.length; n++) "undefined" == typeof y[n]._buttonOffset && (y[n]._buttonOffset = y[n].offsetLeft), p = y[n]._buttonOffset, D = o(y[n]), k.length > 0 && D.hasClass("swipeout-overswipe") && (D.css({
                            left: (S ? -p : 0) + "px"
                    ...
                    if (f.length > 0)
                        for (O = v / h, v > h && (v = h + Math.pow(v - h, .8), T.length > 0 && (P = !0)), n = 0; n < C.length; n++) "undefined" == typeof C[n]._buttonOffset && (C[n]._buttonOffset = h - C[n].offsetLeft - C[n].offsetWidth), p = C[n]._buttonOffset, D = o(C[n]), T.length > 0 && D.hasClass("swipeout-overswipe") && (D.css({
                            left: (P ? p : 0) + "px"
            ...
            function n(e) {
                ...
                if (T = "to-left" === x ? I : M, n = "to-left" === x ? m : f, t = "to-left" === x ? g : h, a = k < 300 && (d < -10 && "to-left" === x || d > 10 && "to-right" === x) || k >= 300 && Math.abs(v) > t / 2 ? "open" : "close", k < 300 && (0 === Math.abs(v) && (a = "close"), Math.abs(v) === t && (a = "open")), "open" === a) {
                    i.swipeoutOpenedEl = c, c.trigger("open"), c.addClass("swipeout-opened transitioning");
                    var E = "to-left" === x ? -t : t;
                    if (u.transform("translate3d(" + E + "px,0,0)"), n.addClass("swipeout-actions-opened"), l = "to-left" === x ? y : C)
                        for (w = 0; w < l.length; w++) o(l[w]).transform("translate3d(" + E + "px,0,0)");
                ...
                var O;
                if (C && C.length > 0 && C !== l)
                    for (w = 0; w < C.length; w++) O = C[w]._buttonOffset, "undefined" == typeof O && (C[w]._buttonOffset = h - C[w].offsetLeft - C[w].offsetWidth), o(C[w]).transform("translate3d(" + O + "px,0,0)");
                if (y && y.length > 0 && y !== l)
                    for (w = 0; w < y.length; w++) O = y[w]._buttonOffset, "undefined" == typeof O && (y[w]._buttonOffset = y[w].offsetLeft), o(y[w]).transform("translate3d(" + -O + "px,0,0)");
            ...
            function e(e) {
                r = !1, n = !0, s = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, p = o(this).parent(), v = p.index(), c = p.parent().find("li"), g = p.parents(".sortable"), e.preventDefault(), i.allowPanelOpen = i.allowSwipeout = !1
            }
                ...
                if (0 !== a.length) {
                    ...
                    if (0 !== t.length) {
                        ...
                        a.on("change", function () {
                            for (var a = [], n = 0; n < t.length; n++) t[n].selected && a.push(t[n].textContent.trim());
            ...
            function s(a) {
                if (a = o(a), C) {
                    var t = i.virtualList(a.find(".virtual-list"), {
                        ...
                        searchByItem: function (e, a, t) {
                            return t.text.toLowerCase().indexOf(e.trim().toLowerCase()) >= 0
                        }
                    });
                ...
                F && r(a), g && a.find('input[type="radio"][name="' + q + '"]:checked').parents("label").once("click", function () {
                    ...
                    P.trigger("change"), e.find(".item-after").text(s.join(", ")), g && "radio" === Y && ("popup" === c ? i.closeModal(re) : "picker" === c ? i.closeModal(ie) : d.router.back())
                })
            }
                ...
                if (0 !== d.length) {
                    ...
                    if (!(k.disabled || e.hasClass("disabled") || P.hasClass("disabled"))) {
                        ...
                        var re, ie, se = '<form class="searchbar searchbar-init" data-search-list=".smart-select-list-' + V + '" data-search-in=".item-title"><div class="searchbar-input"><input type="search" placeholder="' + ee + '"><a href="#" class="searchbar-clear"></a></div>' + (x ? "" : '<a href="#" class="searchbar-cancel">' + ae + "</a>") + '</form><div class="searchbar-overlay"></div>',
                            oe = ("picker" !== c && "through" === J ? U : "") + '<div class="pages">  <div data-page="' + te + '" data-select-name="' + X + '" class="page smart-select-page ' + K + " " + Z + " " + $ + '">' + ("picker" !== c && "fixed" === J ? U : "") + (ne ? se : "") + '    <div class="page-content">' + ("picker" !== c && "static" === J ? U : "") + '      <div class="list-block ' + (C ? "virtual-list" : "") + " smart-select-list-" + V + " " + (v ? "theme-" + v : "") + '">        <ul>' + (C ? "" : j) + "        </ul>      </div>    </div>  </div></div>";
                        "popup" === c ? (a ? (re = o(".popup.smart-select-popup .view"), re.html(oe)) : (re = i.popup('<div class="popup smart-select-popup smart-select-popup-' + q + '"><div class="view navbar-fixed">' + oe + "</div></div>"), re = o(re)), i.initPage(re.find(".page")), s(re)) : "picker" === c ? (a ? (ie = o(".picker-modal.smart-select-picker .view"), ie.html(oe)) : (ie = i.pickerModal('<div class="picker-modal smart-select-picker smart-select-picker-' + q + '"' + (T ? ' style="height:' + T + '"' : "") + ">" + Q + '<div class="picker-modal-inner"><div class="view">' + oe + "</div></div></div>"), ie = o(ie), t(), o("html").on("click", n), ie.once("close", function () {
        ...
        var g = function (e, a) {
            ...
            return r.setListSize = function () {
                ...
                var a, t = 0;
                if (g)
                    for (var n = 0; n < e; n++) t += r.heights[n];
        ...
        i.virtualList = function (e, a) {
            ...
            if (l.hasClass("pull-to-refresh-content") || (l = l.find(".pull-to-refresh-content")), l && 0 !== l.length) {
                ...
                l.on(i.touchEvents.start, a, I), l.on(i.touchEvents.move, t), l.on(i.touchEvents.end, n, I), 0 !== S.length && (l[0].f7DestroyPullToRefresh = r, S.on("pageBeforeRemove", s))
            }
            ...
            var c = r.children(".tab.active").removeClass("active").trigger("hide");
            ...
            function l(e) {
                var a = o(e);
                return ("input" !== e.nodeName.toLowerCase() || "file" !== e.type) && (("select" !== e.nodeName.toLowerCase() || !i.device.android) && (!(a.hasClass("no-fastclick") || a.parents(".no-fastclick").length > 0) && (!i.params.fastClicksExclude || !a.is(i.params.fastClicksExclude))))
            }
            ...
            function h(e, a, t) {
                ...
                q[0].clientLeft;
                X = "translate3d(" + (-r.x + s / 2) + "px, " + (-r.y + i / 2) + "px, 0) scale(1)", q.transform(X)
            }
            ...
            function g() {
                if (q) {
                    ...
                    q.addClass("ripple-wave-fill").transform(X.replace("scale(1)", "scale(1.01)")).transitionEnd(function () {
                        clearTimeout(a);
                        var e = o(this).addClass("ripple-wave-out").transform(X.replace("scale(1)", "scale(1.01)"));
                        a = setTimeout(function () {
                            e.remove()
            ...
            function w() {
                q ? g() : F && !B ? (clearTimeout(G), h(S, M, F), setTimeout(g, 0)) : g()
            }
            ...
            function y(r) {
                ...
                i.device.android && s(r.target) && document.activeElement.blur(), O = !0, E = r.target, I = (new Date).getTime(), S = r.targetTouches[0].pageX, M = r.targetTouches[0].pageY, i.device.ios && (z = void 0, o(E).parents().each(function () {
                    var e = this;
            ...
            function T(e) {
                if (clearTimeout(R), clearTimeout(H), !O) return !D && V && (i.device.android && !e.cancelable || e.preventDefault()), !0;
                if (document.activeElement === e.target) return i.params.activeState && n(), i.params.material && i.params.materialRipple && w(), !0;
                if (D || e.preventDefault(), e.timeStamp - L < i.params.fastClicksDelayBetweenClicks) return setTimeout(n, 0), !0;
                if (L = e.timeStamp, O = !1, i.device.ios && z && z.scrollTop !== z.f7ScrollTop) return !1;
            ...
            var S, M, I, E, O, D, z, L, B, N, H, A, R, V, Y, q, F, X, G;
            ...
            o(document).on("click", "a, .open-panel, .close-panel, .panel-overlay, .modal-overlay, .popup-overlay, .swipeout-delete, .swipeout-close, .close-popup, .open-popup, .open-popover, .open-login-screen, .close-login-screen .smart-select, .toggle-sortable, .open-sortable, .close-sortable, .accordion-item-toggle, .close-picker, .picker-modal-overlay", a),
                (i.params.scrollTopOnNavbarClick || i.params.scrollTopOnStatusbarClick) && o(document).on("click", ".statusbar-overlay, .navbar .center", e), i.support.touch && !i.device.android && o(document).on(i.params.fastClicks ? "touchstart" : "touchmove", ".panel-overlay, .modal-overlay, .preloader-indicator-overlay, .popup-overlay, .searchbar-overlay", t)
            ...
            }), e.trigger("formToJSON formToData", {
                formData: a
            }), a
            ...
            e.find("input, select, textarea").each(function () {
                ...
                if (a[i] && !(t.indexOf(s) >= 0) && !(n.indexOf(i) >= 0) && i) {
                    ...
                    "select" === l && r.parents(".smart-select").length > 0 && r.trigger("change")
                }
            }), e.trigger("formFromJSON formFromData", {
                formData: a
            })
        ...
        var w = function (e) {
            function a() {
                var e = !1;
                return p.params.convertToPopover || p.params.onlyInPopover ? (!p.inline && p.params.input && (p.params.onlyInPopover ? e = !0 : i.device.ios ? e = !!i.device.ipad : o(window).width() >= 768 && (e = !0)), e) : e
            }
            ...
            return p.setValue = function (e, a) {
                ...
                function n(e) {
                    y || C || (e.preventDefault(), C = !0, x = T = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, k = (new Date).getTime(), z = !0, S = I = o.getTranslate(m.wrapper[0], "y"))
                }

                function r(e) {
                    if (C) {
                        e.preventDefault(), z = !1, T = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY, y || (o.cancelAnimationFrame(w), y = !0, S = I = o.getTranslate(m.wrapper[0], "y"), m.wrapper.transition(0));
                        var a = T - x;
                        I = S + a, M = void 0, I < v && (I = v - Math.pow(v - I, .8), M = "min"), I > b && (I = b + Math.pow(I - b, .8), M = "max"), m.wrapper.transform("translate3d(0," + I + "px,0)"), m.updateItems(void 0, I, 0, p.params.updateValuesOnTouchmove), O = I - E || I, D = (new Date).getTime(), E = I
                    }
                }
                ...
                function s(e) {
                    ...
                    var a, n;
                    P - k > 300 ? n = I : (a = Math.abs(O / (P - D)), n = I + O * p.params.momentumRatio), n = Math.max(Math.min(n, b), v);
                ...
                if (!m.divider) {
                    ...
                    var C, y, x, T, k, P, S, M, I, E, O, D, z = !0;
        ...
        var C = function (e) {
            ...
            return p.animating = !1, p.addValue = function (e) {
                ...
                p.params.touchMove && (p.wrapper.on(i.touchEvents.start, e, k), p.wrapper.on(i.touchEvents.move, a), p.wrapper.on(i.touchEvents.end, t, k)), p.container[0].f7DestroyCalendarEvents = function () {
                    p.container.find(".picker-calendar-prev-month").off("click", p.prevMonth), p.container.find(".picker-calendar-next-month").off("click", p.nextMonth), p.container.find(".picker-calendar-prev-year").off("click", p.prevYear), p.container.find(".picker-calendar-next-year").off("click", p.nextYear), p.wrapper.off("click", n), p.params.touchMove && (p.wrapper.off(i.touchEvents.start, e, k), p.wrapper.off(i.touchEvents.move, a), p.wrapper.off(i.touchEvents.end, t, k))
                }
        ...
        i.addNotification = function (e) {
            ...
            if (e = o(e), 0 !== e.length && !e.hasClass("notification-item-removing")) {
                ...
                e.css({
                    height: "0px",
                    marginBottom: "0px"
                }).transition(""), e.data("f7NotificationOnClose") && e.data("f7NotificationOnClose")(), 0 === a.find(".notification-item:not(.notification-item-removing)").length && a.transform(""), e.addClass("notification-hidden").transitionEnd(function () {
    ...
    var e = function () {
        ...
        a.ajax = function (e) {
                ...
                return g.onload = function (a) {
                    ...
                    xhr: g
                }, "start", g), r(void 0, void 0, "beforeSend", g), e.timeout > 0 && (g.onabort = function () {
                    T && clearTimeout(T)
            ...
            function () {
                ...
                var a, t, n, e = e || location.href,
                    r = {};
                if ("string" == typeof e && e.length) {
                    if (e = e.indexOf("#") > -1 ? e.split("#")[0] : e, !(e.indexOf("?") > -1)) return r;
                ...
                for (var l in e)
                    if (e.hasOwnProperty(l)) {
                        ...
                        } else null === e[l] ? i.push(n(l) + "=") : "object" == typeof e[l] ? (o = t.slice(), o.push(l), p = a.serializeObject(e[l], o), "" !== p && i.push(p)) : "undefined" != typeof e[l] && "" !== e[l] && i.push(n(l) + "=" + r(e[l]))
                    }
                return i.join(s)
        ...
        for (var r = [{
            ...
            for (var o = r[s].letters, l = 0; l < o.length; l++) i[o[l]] = r[s].base;
    ...
    window.Animate7 = function (e, a, n) {
                    ...
                    for (c = 0; c < o.length; c++) {
                        ...
                        if ("plain" !== u.type) {
                            ...
                            if ("variable" === u.type && (m = i(u.contextName, p), d += "r += c(" + m + ", " + p + ");"), "helper" === u.type)
                                if (u.helperName in l.helpers) f = s(u.contextName, p), d += "r += (Template7.helpers." + u.helperName + ").call(" + p + ", " + (f && f + ", ") + "{hash:" + JSON.stringify(u.hash) + ", data: data || {}, fn: " + t(u, a + 1) + ", inverse: " + n(u, a + 1) + ", root: root});";
                                else {
        ...
        function p(e, t) {
            e = a(e);
            var n, r, i, s = b.rtl ? -1 : 1;
            n = e.attr("data-swiper-parallax") || "0", r = e.attr("data-swiper-parallax-x"), i = e.attr("data-swiper-parallax-y"), r || i ? (r = r || "0", i = i || "0") : b.isHorizontal() ? (r = n, i = "0") : (i = n, r = "0"), r = r.indexOf("%") >= 0 ? parseInt(r, 10) * t * s + "%" : r * t * s + "px", i = i.indexOf("%") >= 0 ? parseInt(i, 10) * t + "%" : i * t + "px", e.transform("translate3d(" + r + ", " + i + ",0px)")
        }
        ...
        var m = {};
        for (var f in n)
            if ("object" != typeof n[f] || null === n[f] || (n[f].nodeType || n[f] === window || n[f] === document || "undefined" != typeof e && n[f] instanceof e || "undefined" != typeof jQuery && n[f] instanceof jQuery)) m[f] = n[f];
            else {
                m[f] = {};
                for (var h in n[f]) m[f][h] = n[f][h]
            }
        for (var g in c)
            if ("undefined" == typeof n[g]) n[g] = c[g];
            else if ("object" == typeof n[g])
            for (var v in c[g]) "undefined" == typeof n[g][v] && (n[g][v] = c[g][v]);
        var b = this;
        if (b.params = n, b.originalParams = m, b.classNames = [], "undefined" != typeof a && "undefined" != typeof e && (a = e), ("undefined" != typeof a || (a = "undefined" == typeof e ? window.Dom7 || window.Zepto || window.jQuery : e)) && (b.$ = a, b.currentBreakpoint = void 0, b.getActiveBreakpoint = function () {
            ...
            b.container[0].swiper = b, b.container.data("swiper", b), b.classNames.push(b.params.containerModifierClass + b.params.direction), b.params.freeMode && b.classNames.push(b.params.containerModifierClass + "free-mode"), b.support.flexbox || (b.classNames.push(b.params.containerModifierClass + "no-flexbox"), b.params.slidesPerColumn = 1), b.params.autoHeight && b.classNames.push(b.params.containerModifierClass + "autoheight"), (b.params.parallax || b.params.watchSlidesVisibility) && (b.params.watchSlidesProgress = !0), b.params.touchReleaseOnEdges && (b.params.resistanceRatio = 0), ["cube", "coverflow", "flip"].indexOf(b.params.effect) >= 0 && (b.support.transforms3d ? (b.params.watchSlidesProgress = !0, b.classNames.push(b.params.containerModifierClass + "3d")) : b.params.effect = "slide"), "slide" !== b.params.effect && b.classNames.push(b.params.containerModifierClass + b.params.effect), "cube" === b.params.effect && (b.params.resistanceRatio = 0, b.params.slidesPerView = 1, b.params.slidesPerColumn = 1, b.params.slidesPerGroup = 1, b.params.centeredSlides = !1, b.params.spaceBetween = 0, b.params.virtualTranslate = !0, b.params.setWrapperSize = !1), "fade" !== b.params.effect && "flip" !== b.params.effect || (b.params.slidesPerView = 1, b.params.slidesPerColumn = 1, b.params.slidesPerGroup = 1, b.params.watchSlidesProgress = !0, b.params.spaceBetween = 0, b.params.setWrapperSize = !1, "undefined" == typeof u && (b.params.virtualTranslate = !0)), b.params.grabCursor && b.support.touch && (b.params.grabCursor = !1), b.wrapper = b.container.children("." + b.params.wrapperClass), b.params.pagination && (b.paginationContainer = a(b.params.pagination), b.params.uniqueNavElements && "string" == typeof b.params.pagination && b.paginationContainer.length > 1 && 1 === b.container.find(b.params.pagination).length && (b.paginationContainer = b.container.find(b.params.pagination)), "bullets" === b.params.paginationType && b.params.paginationClickable ? b.paginationContainer.addClass(b.params.paginationModifierClass + "clickable") : b.params.paginationClickable = !1, b.paginationContainer.addClass(b.params.paginationModifierClass + b.params.paginationType)), (b.params.nextButton || b.params.prevButton) && (b.params.nextButton && (b.nextButton = a(b.params.nextButton), b.params.uniqueNavElements && "string" == typeof b.params.nextButton && b.nextButton.length > 1 && 1 === b.container.find(b.params.nextButton).length && (b.nextButton = b.container.find(b.params.nextButton))), b.params.prevButton && (b.prevButton = a(b.params.prevButton), b.params.uniqueNavElements && "string" == typeof b.params.prevButton && b.prevButton.length > 1 && 1 === b.container.find(b.params.prevButton).length && (b.prevButton = b.container.find(b.params.prevButton)))), b.isHorizontal = function () {
            ...
            }, b.params.grabCursor && b.setGrabCursor(), b.imagesToLoad = [], b.imagesLoaded = 0, b.loadImage = function (e, a, t, n, r, i) {
                function s() {
                    i && i()
                }
                var o;
                ...
                if ("auto" !== b.params.slidesPerView && b.params.slidesPerView > 1)
                    for (i = 0; i < Math.ceil(b.params.slidesPerView); i++) {
                        var t = b.activeIndex + i;
                ...
                if ("undefined" != typeof b.size) {
                    ...
                    for (e = 0; e < b.slides.length; e++) {
                        ...
                        if (b.params.slidesPerColumn > 1) {
                            var u, m, f;
                            "column" === b.params.slidesPerColumnFill ? (m = Math.floor(e / l), f = e - m * l, (m > d || m === d && f === l - 1) && ++f >= l && (f = 0, m++), u = m + f * s / l, c.css({
                                "-webkit-box-ordinal-group": u,
                                "-moz-box-ordinal-group": u,
                                "-ms-flex-order": u,
                                "-webkit-order": u,
                                order: u
                            })) : (f = Math.floor(e / p), m = e - f * p), c.css("margin-" + (b.isHorizontal() ? "top" : "left"), 0 !== f && b.params.spaceBetween && b.params.spaceBetween + "px").attr("data-swiper-column", m).attr("data-swiper-row", f)
                        }
                        "none" !== c.css("display") && ("auto" === b.params.slidesPerView ? (o = b.isHorizontal() ? c.outerWidth(!0) : c.outerHeight(!0), b.params.roundLengths && (o = r(o))) : (o = (b.size - (b.params.slidesPerView - 1) * a) / b.params.slidesPerView, b.params.roundLengths && (o = r(o)), b.isHorizontal() ? b.slides[e].style.width = o + "px" : b.slides[e].style.height = o + "px"), b.slides[e].swiperSlideSize = o, b.slidesSizesGrid.push(o), b.params.centeredSlides ? (t = t + o / 2 + n / 2 + a, 0 === e && (t = t - b.size / 2 - a), Math.abs(t) < .001 && (t = 0), i % b.params.slidesPerGroup === 0 && b.snapGrid.push(t), b.slidesGrid.push(t)) : (i % b.params.slidesPerGroup === 0 && b.snapGrid.push(t), b.slidesGrid.push(t), t = t + o + a), b.virtualSize += o + a, n = o, i++)
                    }
                ...
                if ("undefined" == typeof e && (e = b.translate || 0), 0 !== b.slides.length) {
                    ...
                    for (var t = 0; t < b.slides.length; t++) {
                        var n = b.slides[t],
                            r = (a + (b.params.centeredSlides ? b.minTranslate() : 0) - n.swiperSlideOffset) / (n.swiperSlideSize + b.params.spaceBetween);
                        if (b.params.watchSlidesVisibility) {
                            var i = -(a - n.swiperSlideOffset),
                                s = i + b.slidesSizesGrid[t],
                                o = i >= 0 && i < b.size || s > 0 && s <= b.size || i <= 0 && s >= b.size;
                ...
                b.params.lazyLoading && !n && b.lazy && b.lazy.load(), b.params.allowSwipeToPrev = a, b.params.allowSwipeToNext = t
                ...
                var a = e ? "off" : "on",
                    ...
                    s = !!b.params.nested;
                if (b.browser.ie) r[t](b.touchEvents.start, b.onTouchStart, !1), i[t](b.touchEvents.move, b.onTouchMove, s),
                    ...
                    if (b.support.touch) {
                        ...
                        r[t](b.touchEvents.start, b.onTouchStart, o), r[t](b.touchEvents.move, b.onTouchMove, s), r[t](b.touchEvents.end, b.onTouchEnd, o)
                    }(n.simulateTouch && !b.device.ios && !b.device.android || n.simulateTouch && !b.support.touch && b.device.ios) && (r[t]("mousedown", b.onTouchStart, !1), document[t]("mousemove", b.onTouchMove, s), document[t]("mouseup", b.onTouchEnd, !1))
                }
                ...
                var t = o(e, "." + b.params.slideClass),
                    n = !1;
                if (t)
                    for (var r = 0; r < b.slides.length; r++) b.slides[r] === t && (n = !0);
                ...
                if (b.clickedSlide = t, b.clickedIndex = a(t).index(), b.params.slideToClickedSlide && void 0 !== b.clickedIndex && b.clickedIndex !== b.activeIndex) {
                    ...
                    if (b.params.loop) {
                        ...
                        i = a(b.clickedSlide).attr("data-swiper-slide-index"), b.params.centeredSlides ? s < b.loopedSlides - b.params.slidesPerView / 2 || s > b.slides.length - b.loopedSlides + b.params.slidesPerView / 2 ? (b.fixLoop(), s = b.wrapper.children("." + b.params.slideClass + '[data-swiper-slide-index="' + i + '"]:not(.' + b.params.slideDuplicateClass + ")").eq(0).index(), setTimeout(function () {
                            b.slideTo(s)
                        }, 0)) : b.slideTo(s) : s > b.slides.length - b.params.slidesPerView ? (b.fixLoop(), s = b.wrapper.children("." + b.params.slideClass + '[data-swiper-slide-index="' + i + '"]:not(.' + b.params.slideDuplicateClass + ")").eq(0).index(), setTimeout(function () {
                            b.slideTo(s)
                        }, 0)) : b.slideTo(s)
                    } else b.slideTo(s)
                }
            };
            var C, y, x, T, k, P, S, M, I, E, O = "input, select, textarea, button, video",
                D = Date.now(),
                z = [];
            ...
            b.onTouchStart = function (e) {
                if (e.originalEvent && (e = e.originalEvent), L = "touchstart" === e.type, L || !("which" in e) || 3 !== e.which) {
                    ...
                    if (!b.params.swipeHandler || o(e, b.params.swipeHandler)) {
                        ...
                        if (!(b.device.ios && b.params.iOSEdgeSwipeDetection && t <= b.params.iOSEdgeSwipeThreshold)) {
                            if (C = !0, y = !1, x = !0, k = void 0, B = void 0, b.touches.startX = t, b.touches.startY = n, T = Date.now(), b.allowClick = !0, b.updateContainerSize(), b.swipeDirection = void 0, b.params.threshold > 0 && (M = !1), "touchstart" !== e.type) {
                                var r = !0;
                                a(e.target).is(O) && (r = !1), document.activeElement && a(document.activeElement).is(O) && document.activeElement.blur(), r && e.preventDefault()
                            }
                ...
                if (e.originalEvent && (e = e.originalEvent), !L || "mousemove" !== e.type) {
                    ...
                    if (L && document.activeElement && e.target === document.activeElement && a(e.target).is(O)) return y = !0, void(b.allowClick = !1);
                    if (x && b.emit("onTouchMove", b, e), !(e.targetTouches && e.targetTouches.length > 1)) {
                        if (b.touches.currentX = "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX, b.touches.currentY = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY, "undefined" == typeof k) {
                            var t;
                            b.isHorizontal() && b.touches.currentY === b.touches.startY || !b.isHorizontal() && b.touches.currentX !== b.touches.startX ? k = !1 : (t = 180 * Math.atan2(Math.abs(b.touches.currentY - b.touches.startY), Math.abs(b.touches.currentX - b.touches.startX)) / Math.PI, k = b.isHorizontal() ? t > b.params.touchAngle : 90 - t > b.params.touchAngle)
                        }
                        if (k && b.emit("onTouchMoveOpposite", b, e), "undefined" == typeof B && b.browser.ieTouch && (b.touches.currentX === b.touches.startX && b.touches.currentY === b.touches.startY || (B = !0)), C) {
                            ...
                            if (B || !b.browser.ieTouch) {
                                ...
                                r *= b.params.touchRatio, b.rtl && (r = -r), b.swipeDirection = r > 0 ? "prev" : "next", P = r + S;
                                var i = !0;
                                if (r > 0 && P > b.minTranslate() ? (i = !1, b.params.resistance && (P = b.minTranslate() - 1 + Math.pow(-b.minTranslate() + S + r, b.params.resistanceRatio))) : r < 0 && P < b.maxTranslate() && (i = !1, b.params.resistance && (P = b.maxTranslate() + 1 - Math.pow(b.maxTranslate() - S - r, b.params.resistanceRatio))), i && (e.preventedByNestedSwiper = !0), !b.params.allowSwipeToNext && "next" === b.swipeDirection && P < S && (P = S), !b.params.allowSwipeToPrev && "prev" === b.swipeDirection && P > S && (P = S), b.params.threshold > 0) {
                                    if (!(Math.abs(r) > b.params.threshold || M)) return void(P = S);
                                    if (!M) return M = !0, b.touches.startX = b.touches.currentX, b.touches.startY = b.touches.currentY, P = S, void(b.touches.diff = b.isHorizontal() ? b.touches.currentX - b.touches.startX : b.touches.currentY - b.touches.startY)
                                }
                                b.params.followFinger && ((b.params.freeMode || b.params.watchSlidesProgress) && b.updateActiveIndex(), b.params.freeMode && (0 === z.length && z.push({
                ...
                if (e.originalEvent && (e = e.originalEvent), x && b.emit("onTouchEnd", b, e), x = !1, C) {
                    b.params.grabCursor && y && C && (b.params.allowSwipeToNext === !0 || b.params.allowSwipeToPrev === !0) && b.setGrabCursor(!1);
                    var t = Date.now(),
                        n = t - T;
                    if (b.allowClick && (b.updateClickedSlide(e), b.emit("onTap", b, e), n < 300 && t - D > 300 && (I && clearTimeout(I), I = setTimeout(function () {
                            b && (b.params.paginationHide && b.paginationContainer.length > 0 && !a(e.target).hasClass(b.params.bulletClass) && b.paginationContainer.toggleClass(b.params.paginationHiddenClass), b.emit("onClick", b, e))
                        }, 300)), n < 300 && t - D < 300 && (I && clearTimeout(I), b.emit("onDoubleTap", b, e))), D = Date.now(), setTimeout(function () {
                            b && (b.allowClick = !0)
                    ...
                    if (r = b.params.followFinger ? b.rtl ? b.translate : -b.translate : -P, b.params.freeMode) {
                        ...
                        if (b.params.freeModeMomentum) {
                            ...
                            b.velocity = b.velocity * b.params.freeModeMomentumVelocityRatio, z.length = 0;
                            ...
                            if (c < b.maxTranslate()) b.params.freeModeMomentumBounce ? (c + b.maxTranslate() < -f && (c = b.maxTranslate() - f), u = b.maxTranslate(), m = !0, E = !0) : c = b.maxTranslate();
                            else if (c > b.minTranslate()) b.params.freeModeMomentumBounce ? (c - b.minTranslate() > f && (c = b.minTranslate() + f), u = b.minTranslate(), m = !0, E = !0) : c = b.minTranslate();
                            ...
                            b.params.freeModeMomentumBounce && m ? (b.updateProgress(u), b.setWrapperTransition(p), b.setWrapperTranslate(c), b.onTransitionStart(), b.animating = !0, b.wrapper.transitionEnd(function () {
                                b && E && (b.emit("onMomentumBounce", b), b.setWrapperTransition(b.params.speed), b.setWrapperTranslate(u), b.wrapper.transitionEnd(function () {
                                    b && b.onTransitionEnd()
                                }))
                ...
                if (b.params.autoplay && b.autoplaying && (n || !b.params.autoplayDisableOnInteraction ? b.pauseAutoplay(a) : b.stopAutoplay()), b.updateProgress(r), b.params.normalizeSlideIndex)
                ...
                if ("object" == typeof e && e.length) {
                    for (var n = 0; n < e.length; n++) a = e[n], b.slides[a] && b.slides.eq(a).remove(), a < t && t--;
                    t = Math.max(t, 0)
                ...
                flip: {
                    setTranslate: function () {
                        for (var e = 0; e < b.slides.length; e++) {
                            var t = b.slides.eq(e),
                                n = t[0].progress;
                            b.params.flip.limitRotation && (n = Math.max(Math.min(t[0].progress, 1), -1));
                            var r = t[0].swiperSlideOffset,
                                ...
                                l = -r,
                                p = 0;
                            if (b.isHorizontal() ? b.rtl && (s = -s) : (p = l, l = 0, o = -s, s = 0), t[0].style.zIndex = -Math.abs(Math.round(n)) + b.slides.length, b.params.flip.slideShadows) {
                                var d = b.isHorizontal() ? t.find(".swiper-slide-shadow-left") : t.find(".swiper-slide-shadow-top"),
                                    c = b.isHorizontal() ? t.find(".swiper-slide-shadow-right") : t.find(".swiper-slide-shadow-bottom");
                                0 === d.length && (d = a('<div class="swiper-slide-shadow-' + (b.isHorizontal() ? "left" : "top") + '"></div>'), t.append(d)), 0 === c.length && (c = a('<div class="swiper-slide-shadow-' + (b.isHorizontal() ? "right" : "bottom") + '"></div>'), t.append(c)), d.length && (d[0].style.opacity = Math.max(-n, 0)), c.length && (c[0].style.opacity = Math.max(n, 0))
                            }
                    ...
                    setTranslate: function () {
                        ...
                        for (var n = 0; n < b.slides.length; n++) {
                            ...
                            var o = Math.max(Math.min(r[0].progress, 1), -1),
                                ...
                                p = 0,
                                d = 0;
                            n % 4 === 0 ? (l = 4 * -s * b.size, d = 0) : (n - 1) % 4 === 0 ? (l = 0, d = 4 * -s * b.size) : (n - 2) % 4 === 0 ? (l = b.size + 4 * s * b.size, d = b.size) : (n - 3) % 4 === 0 && (l = -b.size, d = 3 * b.size + 4 * b.size * s), b.rtl && (l = -l), b.isHorizontal() || (p = l, l = 0);
                            var c = "rotateX(" + (b.isHorizontal() ? 0 : -i) + "deg) rotateY(" + (b.isHorizontal() ? i : 0) + "deg) translate3d(" + l + "px, " + p + "px, " + d + "px)";
                            if (o <= 1 && o > -1 && (t = 90 * n + 90 * o, b.rtl && (t = 90 * -n - 90 * o)), r.transform(c), b.params.cube.slideShadows) {
                                var u = b.isHorizontal() ? r.find(".swiper-slide-shadow-left") : r.find(".swiper-slide-shadow-top"),
                                    m = b.isHorizontal() ? r.find(".swiper-slide-shadow-right") : r.find(".swiper-slide-shadow-bottom");
                                0 === u.length && (u = a('<div class="swiper-slide-shadow-' + (b.isHorizontal() ? "left" : "top") + '"></div>'), r.append(u)), 0 === m.length && (m = a('<div class="swiper-slide-shadow-' + (b.isHorizontal() ? "right" : "bottom") + '"></div>'), r.append(m)), u.length && (u[0].style.opacity = Math.max(-o, 0)), m.length && (m[0].style.opacity = Math.max(o, 0))
                            }
                        }
                        if (b.wrapper.css({
                        ...
                        var C = b.isSafari || b.isUiWebView ? -b.size / 2 : 0;
                        b.wrapper.transform("translate3d(0px,0," + C + "px) rotateX(" + (b.isHorizontal() ? 0 : t) + "deg) rotateY(" + (b.isHorizontal() ? -t : 0) + "deg)")
                    },
                    setTransition: function (e) {
                ...
                coverflow: {
                    setTranslate: function () {
                        for (var e = b.translate, t = b.isHorizontal() ? -e + b.width / 2 : -e + b.height / 2, n = b.isHorizontal() ? b.params.coverflow.rotate : -b.params.coverflow.rotate, r = b.params.coverflow.depth, i = 0, s = b.slides.length; i < s; i++) {
                            var o = b.slides.eq(i),
                    ...
                    if ("undefined" != typeof e && ("undefined" == typeof t && (t = !0), 0 !== b.slides.length)) {
                        ...
                        !n.hasClass(b.params.lazyLoadingClass) || n.hasClass(b.params.lazyStatusLoadedClass) || n.hasClass(b.params.lazyStatusLoadingClass) || (r = r.add(n[0])), 0 !== r.length && r.each(function () {
                            ...
                            var r = e.attr("data-background"),
                                ...
                                o = e.attr("data-sizes");
                            b.loadImage(e[0], i || r, s, o, !1, function () {
                                if (r ? (e.css("background-image", 'url("' + r + '")'), e.removeAttr("data-background")) : (s && (e.attr("srcset", s), e.removeAttr("data-srcset")), o && (e.attr("sizes", o), e.removeAttr("data-sizes")), i && (e.attr("src", i), e.removeAttr("data-src"))), e.addClass(b.params.lazyStatusLoadedClass).removeClass(b.params.lazyStatusLoadingClass), n.find("." + b.params.lazyPreloaderClass + ", ." + b.params.preloaderClass).remove(), b.params.loop && t) {
                    ...
                    if (b.params.lazyLoadingInPrevNext)
                        if (t > 1 || b.params.lazyLoadingInPrevNextAmount && b.params.lazyLoadingInPrevNextAmount > 1) {
                            var n = b.params.lazyLoadingInPrevNextAmount,
                                ...
                                s = Math.max(b.activeIndex - Math.max(r, n), 0);
                ...
                setDragPosition: function (e) {
                    var a = b.scrollbar,
                        ...
                        n = t - a.track.offset()[b.isHorizontal() ? "left" : "top"] - a.dragSize / 2,
                        r = -b.minTranslate() * a.moveDivider,
                        i = -b.maxTranslate() * a.moveDivider;
                    n < r ? n = r : n > i && (n = i), n = -n / a.moveDivider, b.updateProgress(n), b.setWrapperTranslate(n, !0)
                },
                ...
                getDistanceBetweenTouches: function (e) {
                    ...
                    var a = e.targetTouches[0].pageX,
                        ...
                        i = Math.sqrt(Math.pow(n - a, 2) + Math.pow(r - t, 2));
                    return i
                },
                ...
                attachEvents: function (e) {
                    ...
                    if (b.params.zoom) {
                        ...
                        b.support.gestures ? (b.slides[t]("gesturestart", b.zoom.onGestureStart, n), b.slides[t]("gesturechange", b.zoom.onGestureChange, n), b.slides[t]("gestureend", b.zoom.onGestureEnd, n)) : "touchstart" === b.touchEvents.start && (b.slides[t](b.touchEvents.start, b.zoom.onGestureStart, n), b.slides[t](b.touchEvents.move, b.zoom.onGestureChange, n), b.slides[t](b.touchEvents.end, b.zoom.onGestureEnd, n)), b[t]("touchStart", b.zoom.onTouchStart), b.slides.each(function (e, n) {
                            a(n).find("." + b.params.zoomContainerClass).length > 0 && a(n)[t](b.touchEvents.move, b.zoom.onTouchMove)
            ...
            for (var N in b.plugins) {
                var H = b.plugins[N](b, b.params[N]);
                H && b._plugins.push(H)
            }
